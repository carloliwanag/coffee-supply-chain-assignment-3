    ...
    ConsumerRole
{
    ...
    struct Item {
        ...
        bool isValue; // flag if item exist
    }
    ...
    modifier checkValue(uint256 _upc) {
        ...
        // i think this should be the owner rather than the consumer
        payable(items[_upc].ownerID).transfer(amountToReturn);
    }
    ...
    function harvestItem(
        ...
        require(_upc > 0);
        require(items[_upc].isValue == false, "This item is already existing");
    ...
    function processItem(uint256 _upc)
        ...
        onlyFarmer
    {
        // a farmer can only process his/her own coffee
    ...
    function packItem(uint256 _upc)
        ...
        onlyFarmer
    {
        // a farmer can only pack his/her own coffee
        require(items[_upc].originFarmerID == msg.sender);
    ...
    function sellItem(uint256 _upc, uint256 _price)
        ...
        onlyFarmer
    {
        // a farmer can only sell his/her own coffee
        require(items[_upc].originFarmerID == msg.sender);
        require(_price > 0);
    ...
    {
        require(items[_upc].isValue == true);
